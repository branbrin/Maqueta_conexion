...
public class Mando6 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mando6);
    ...
    protected void onPause(){
        ...
        ConstraintLayout layout= findViewById(R.id.constraint6);
        Bitmap bmp = screenShot(layout);
        MainActivity.imageView6.setImageBitmap(bmp);
